...
import {init} from "./billyngCycleActions"
...
class BillingCycleForm extends Component {
    ...
    calculateSummary() {
        ...
        return {
            ...
            sumOfDedits: this.props.debts.map(d => +d.value || 0).reduce(sum, 0),
        }
    }

    render() {
        const {sumOfCredits, sumOfDedits} = this.calculateSummary();
        ...
        return (
            <form role='form' onSubmit={handleSubmit}>
                <div className="box-body">
                    ...
                    <Summary credit={sumOfCredits} debt={sumOfDedits}/>
